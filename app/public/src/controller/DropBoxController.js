class DropBoxController {
  ...
  connectFirebase(){
    ...
    const firebaseConfig = {
      apiKey: "AIzaSyBKvYKVGjSUB1kWSC8wcmXEfSB6OjoA4fg",
      authDomain: "dropbox-clone-f3f5e.firebaseapp.com",
      databaseURL: "https://dropbox-clone-f3f5e-default-rtdb.firebaseio.com",
      projectId: "dropbox-clone-f3f5e",
      storageBucket: "dropbox-clone-f3f5e.appspot.com",
      messagingSenderId: "627438170616",
      appId: "1:627438170616:web:d77a3bbea0b40fb00ce60d"
    };
    ...
    switch (file.type) {
      ...
      case 'folder':
       ...
       case 'application/pdf':
        return `
          <svg version="1.1" id="Camada_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="160px" height="160px"  viewBox="0 0 160 160" enable-background="new 0 0 160 160" xml:space="preserve"></svg>
          ...
          <g>
            <g> 
              ...
              <g>
                <path id="mc-content-unknown-large-b_1_" fill="#F7F9FA" d="M47,30h66c2.209,0,4,1.791,4,4v92c0,2.209-1.791,4-4,4H47c-2.209,0-4-1.791-4-4V34C43,31.791,44.791,30,47,30z"></path>
              </g>
            </g>
          </g>
        ...
        case 'audio/mp3':
          case 'audio/ogg': 
          return ` 
            <svg width="160" height="160" viewBox="0 0 160 160" class="mc-icon-template-content     
